    ...
    <div className="min-h-screen" style={{ padding: '5rem 1rem' }}>
      <div style={{ maxWidth: '48rem', margin: '0 auto' }}>
        ...
        <div className="flex-col gap-6 text-muted text-sm" style={{ lineHeight: '1.6' }}>
          ...
          <section><h2 className="text-white font-bold text-lg mb-2">Contact</h2><p>Questions? Visit our <Link href="/support" className="text-primary">support page</Link>.</p></section>
        </div>
      </div>
    </div>
  );
