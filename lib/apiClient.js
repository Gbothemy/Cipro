...
export const db = {
  ...
  claimTask: (user_id, task_id, progress = 0) => call('claimTask', { user_id, task_id, progress }),
  ...
  getActiveMiningCount: (user_id) => call('getActiveMiningCount', { user_id }),
  ...
  validateStreak: (user_id) => call('validateStreak', { user_id }),
  ...
  createDepositRequest: (d) => call('createDepositRequest', d),
  getDepositRequests: (user_id = null, status = null) => call('getDepositRequests', { user_id, status }),
  updateDepositStatus: (id, status, processed_by) => call('updateDepositStatus', { id, status, processed_by }),
  recordMiningSession: (user_id, points_earned) => call('recordMiningSession', { user_id, points_earned }),
};
