...
export const db = {
  ...
  authenticateDemo: () => call('authenticateDemo'),
  logout: () => call('logout'),
  resetPassword: (username, email, password) => call('resetPassword', { username, email, password }),
  ...
  completeGame: (user_id, game_type, result) => call('completeGame', { user_id, game_type, result }),
  ...
  claimDailyReward: (user_id) => call('claimDailyReward', { user_id }),
  convertPoints: (user_id, points, currency) => call('convertPoints', { user_id, points, currency }),
  ...
  checkAchievements: (user_id) => call('checkAchievements', { user_id }),
  ...
  purchaseLuckyDrawTickets: (user_id, quantity, currency) => call('purchaseLuckyDrawTickets', { user_id, quantity, currency }),
  useLuckyDrawTicket: (user_id) => call('useLuckyDrawTicket', { user_id }),
  purchaseVip: (user_id, level, currency) => call('purchaseVip', { user_id, level, currency }),
  ...
  startMiningSession: (user_id) => call('startMiningSession', { user_id }),
  cancelMiningSession: (user_id) => call('cancelMiningSession', { user_id }),
  completeMiningSession: (user_id) => call('completeMiningSession', { user_id }),
};
