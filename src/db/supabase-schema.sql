...
('min_withdrawal_sol', '0.1', 'number', 'conversion', 'Minimum SOL withdrawal amount (~$14)'),
('min_withdrawal_eth', '0.005', 'number', 'conversion', 'Minimum ETH withdrawal amount (~$16.50)'),
('min_withdrawal_usdt', '15', 'number', 'conversion', 'Minimum USDT withdrawal amount'),
('min_withdrawal_usdc', '15', 'number', 'conversion', 'Minimum USDC withdrawal amount'),
('conversion_rate_sol', '1400000', 'number', 'conversion', 'Points per 1 SOL (SOL ≈ $140)'),
('conversion_rate_eth', '33000000', 'number', 'conversion', 'Points per 1 ETH (ETH ≈ $3,300)'),
